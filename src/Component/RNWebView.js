 ...
 all_validate_check= async () =>   {
  ...
  render() {
    ...
    return (
      ...
      {/* <View style={{backgroundColor:'black',top:5}}> */}
      <View >
        {/* <TouchableOpacity>   */}
       <Image source={pic} style={{width:width,height:height,top:0}} />
       {/* </TouchableOpacity> */}
      ...
      <Text style={{fontSize:20,color:'red',top:5,width:250,alignSelf:'center'}}>{this.state.warning}</Text>
           ...
           />
            ...
            {/* <CheckBox 
            title="Click here"
            value={this.state.Chacked}
            // onValueChange={()=>}
            /> */}
       </View>
       <View style={{position:'absolute',top:520,width:305,alignSelf:'center'}}> 
       <Text style={{top:1,alignSelf:'center',fontSize:17,color:'white'}}>Already have an account ?</Text>
   <TouchableOpacity onPress={()=>this.props.navigation.navigate('SignIn')}>
       <Text style={{top:1,alignSelf:'center',fontSize:17,color:'red',borderBottomWidth:1,borderBottomColor:'red'}}>Sign In </Text>
       </TouchableOpacity>
       </View>
       
       <View style={{position:'absolute',width:330}}>
         <Image 
            source={logo} style={{width:170,alignSelf:'center',height:200,top:0,borderRadius:15,position:'absolute'}}
         />
       </View>       
            {/* <View > */}
